...
class Hero(DungeonCharacter, ABC):
    def __init__(self, name, dmg_min, dmg_max, speed, hit_chance):
        super().__init__(name, dmg_min, dmg_max, speed, hit_chance)
    ...
    def get_chance_to_block(self):
        self._chance_to_block = random.uniform(0.0,0.15)
